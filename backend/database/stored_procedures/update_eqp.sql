CREATE OR REPLACE FUNCTION update_eqp(_js JSON) RETURNS VOID
    LANGUAGE plpgsql AS
$$
DECLARE
    _eqp_title    VARCHAR;
...
BEGIN
    ...
    INTO _eqp_id,
         ...
         _eqp_buy_date,
         _eqp_qty
    FROM JSON_TO_RECORD(_js) AS s(eqp_id       BIGINT,
                                  eqp_title    VARCHAR,
                                  eqp_descr    VARCHAR,
                                  eqp_type_id  INTEGER,
                                  eqp_wear     INTEGER,
    ...
    SET eqp_title    = _eqp_title,
        eqp_descr    = _eqp_descr,
        eqp_type_id  = _eqp_type_id,
        eqp_wear     = _eqp_wear,
        eqp_supplier = _eqp_supplier,
        eqp_buy_date = _eqp_buy_date,
        eqp_qty      = _eqp_qty
